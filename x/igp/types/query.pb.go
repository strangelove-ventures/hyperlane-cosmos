...
type QuoteGasPaymentRequest struct {
	...
	GasAmount         github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,3,opt,name=gas_amount,json=gasAmount,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"gas_amount"`
}
...
func (m *GetExchangeRateAndGasPriceRequest) GetIgpId() uint32 {
	if m != nil {
		return m.IgpId
	}
	return 0
...
type GetExchangeRateAndGasPriceResponse struct {
	TokenExchangeRate github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,1,opt,name=token_exchange_rate,json=tokenExchangeRate,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"token_exchange_rate"`
...
var fileDescriptor_df73ac8b27e264f2 = []byte{
	...
	,
}
...
func (m *GetBeneficiaryRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.IgpId != 0 {
		i = encodeVarintQuery(dAtA, i, uint64(m.IgpId))
		i--
		dAtA[i] = 0x18
	}
