...
HTTPS_GIT := https://github.com/strangelove-ventures/hyperlane-cosmos.git
...
ldflags = -X github.com/cosmos/cosmos-sdk/version.Name=simd \
		  ...
		  -X github.com/strangelove-ventures/hyperlane-cosmos/app.Bech32Prefix=cosmos \
...
format: format-tools
	...
	find . -name '*.go' -type f -not -path "./vendor*" -not -path "*.git*" -not -path "./client/lcd/statik/statik.go" | xargs goimports -w -local github.com/strangelove-ventures/hyperlane-cosmos
